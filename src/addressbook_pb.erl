...
source_basename() -> "addressbook.proto".
...
get_all_source_basenames() -> ["addressbook.proto"].
...
%% functions.
get_all_proto_names() -> ["addressbook"].


get_msg_containment("addressbook") -> [person];
get_msg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_pkg_containment("addressbook") -> undefined;
get_pkg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_service_containment("addressbook") -> [];
get_service_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_rpc_containment("addressbook") -> [];
get_rpc_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_enum_containment("addressbook") -> [];
get_enum_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_proto_by_msg_name_as_fqbin(<<"person">>) ->
    "addressbook";
