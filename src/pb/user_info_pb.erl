...
-export_type(['RoleInfo'/0]).

-spec encode_msg(#'RoleInfo'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'RoleInfo'{}, atom() | list()) -> binary().
...
get_msg_names() -> ['RoleInfo'].


get_group_names() -> [].


get_msg_or_group_names() -> ['RoleInfo'].
...
source_basename() -> "user_info.proto".
...
get_all_source_basenames() -> ["user_info.proto"].
